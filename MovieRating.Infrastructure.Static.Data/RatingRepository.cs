...
namespace ConsoleApp
{
    public class RatingRepository : IRatingRepository
    {
        ...
        private void InitData()
        {
            ...
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-11-09"), Grade = 1, Movie = m1, Reviewer = re4 });

            allReviews.Add(new Review() { Date = DateTime.Parse("2004-11-09"), Grade = 5, Movie = m2, Reviewer = re1 });
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-11-09"), Grade = 5, Movie = m2, Reviewer = re2 });
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-11-09"), Grade = 2, Movie = m2, Reviewer = re3 });
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-11-09"), Grade = 2, Movie = m2, Reviewer = re4 });
            ...
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-11-09"), Grade = 1, Movie = m3, Reviewer = re3 });
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-11-09"), Grade = 1, Movie = m3, Reviewer = re4 });
