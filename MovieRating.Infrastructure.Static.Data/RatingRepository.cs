...
namespace ConsoleApp
{
    public class RatingRepository : IRatingRepository
    {
        ...
        private void InitDataFor_GetTopMoviesByReviewer()
        {
            ...
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-09-01"), Grade = 3, Movie = 3, Reviewer = 3 });
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-09-01"), Grade = 3, Movie = 4, Reviewer = 3 });

            allReviews.Add(new Review() { Date = DateTime.Parse("2004-09-01"), Grade = 5, Movie = 1, Reviewer = 1 });
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-09-06"), Grade = 5, Movie = 3, Reviewer = 1 });
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-09-13"), Grade = 4, Movie = 3, Reviewer = 1 });
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-09-02"), Grade = 4, Movie = 4, Reviewer = 1 });
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-09-01"), Grade = 3, Movie = 5, Reviewer = 1 });
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-09-01"), Grade = 3, Movie = 6, Reviewer = 1 });
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-09-10"), Grade = 3, Movie = 7, Reviewer = 1 });

            allReviews.Add(new Review() { Date = DateTime.Parse("2004-09-01"), Grade = 5, Movie = 1, Reviewer = 2 });
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-09-09"), Grade = 4, Movie = 3, Reviewer = 2 });
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-09-01"), Grade = 4, Movie = 3, Reviewer = 2 });
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-09-05"), Grade = 1, Movie = 4, Reviewer = 2 });
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-09-08"), Grade = 1, Movie = 5, Reviewer = 2 });

            allReviews.Add(new Review() { Date = DateTime.Parse("2004-09-12"), Grade = 5, Movie = 1, Reviewer = 3 });
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-09-11"), Grade = 4, Movie = 3, Reviewer = 3 });
            allReviews.Add(new Review() { Date = DateTime.Parse("2004-09-09"), Grade = 4, Movie = 5, Reviewer = 3 });
